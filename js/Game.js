class Game{
    ...
    play(){
        ...
        if (frameCount % 20 === 0) {
            fishFood = createSprite(random(100, 1000), 0, 100, 100);
        ...
        if (frameCount % 70 === 0) {
            shark = createSprite(random(100, 1000), 0, 100, 100);
        ...
        if(player.index !== null){
                ...
                //for(var i = 0; i < sharkGroup.length; i++){
                    //if(sharkGroup.collide(players)){ //get(i).
                        //sharkGroup.destroy();  //.get(i).
                        //gameState=2
                   // }
                //}
            }
